...
def migrate(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    class User(pw.Model):
        ...
        score = pw.IntegerField(constraints=[SQL("DEFAULT 0")], default=0)
        nickname = pw.CharField(max_length=255)
        avatar = pw.CharField(max_length=255)
        permission = pw.IntegerField(constraints=[SQL("DEFAULT 0")], default=0)
